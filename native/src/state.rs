...
pub struct Shared {
    ...
    pub vader: AtomicU32,
    pub vader_dark: AtomicU32,
    pub flange: AtomicU32,
    pub flange_rate: AtomicU32,
    pub phaser: AtomicU32,
    pub phaser_rate: AtomicU32,
    pub vibrato: AtomicU32,
    pub vibrato_rate: AtomicU32,
    pub overdrive: AtomicU32,
    pub overdrive_drive: AtomicU32,
    pub underwater: AtomicU32,
    pub underwater_depth: AtomicU32,
...
impl Shared {
    pub fn new() -> Self {
        Self {
            ...
            vader: AtomicU32::new(0f32.to_bits()),
            vader_dark: AtomicU32::new(0.7f32.to_bits()),
            flange: AtomicU32::new(0f32.to_bits()),
            flange_rate: AtomicU32::new(0.35f32.to_bits()),
            phaser: AtomicU32::new(0f32.to_bits()),
            phaser_rate: AtomicU32::new(0.4f32.to_bits()),
            vibrato: AtomicU32::new(0f32.to_bits()),
            vibrato_rate: AtomicU32::new(0.45f32.to_bits()),
            overdrive: AtomicU32::new(0f32.to_bits()),
            overdrive_drive: AtomicU32::new(0.55f32.to_bits()),
            underwater: AtomicU32::new(0f32.to_bits()),
            underwater_depth: AtomicU32::new(0.6f32.to_bits()),
    ...
    pub fn params(&self) -> Params {
        Params {
            ...
            fx: FxKnob {
                ...
                vader: load_f32(&self.vader),
                vader_dark: load_f32(&self.vader_dark),
                flange: load_f32(&self.flange),
                flange_rate: load_f32(&self.flange_rate),
                phaser: load_f32(&self.phaser),
                phaser_rate: load_f32(&self.phaser_rate),
                vibrato: load_f32(&self.vibrato),
                vibrato_rate: load_f32(&self.vibrato_rate),
                overdrive: load_f32(&self.overdrive),
                overdrive_drive: load_f32(&self.overdrive_drive),
                underwater: load_f32(&self.underwater),
                underwater_depth: load_f32(&self.underwater_depth),
            },
        }
    }
